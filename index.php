...
<body>
	<!--start-header-->
					...
					<div class="top-header">
						<div class="container">
							...
							<!--start-top-nav-->
							 <div class="top-nav">
								<ul>
									<li><a class="play-icon popup-with-zoom-anim" href="adminLogin.php">Admin Login</a></li>
		...
		<div class="banner">
			<div class="container">
				<div class="bnr-text">
					<h1>AGRICULTURE IS OUR PASSION</h1>
					<div class="bttn">
			...
			<div class="container">
				<div class="contact-main">
					<div class="col-md-4 contact-left">
						...
						<p><span>Email:</span><a href="mailto:@example.com">agroxyforum@gmail.com</a></p>
						<p><span>Phone:</span>+2348178112035</p>
					</div>
					<div class="col-md-4 contact-left">
						<h4>Address</h4>
